...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.scss */ \"./src/styles.scss\");\n/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_styles_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var aos__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! aos */ \"./node_modules/aos/dist/aos.js\");\n/* harmony import */ var aos__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(aos__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var aos_dist_aos_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! aos/dist/aos.css */ \"./node_modules/aos/dist/aos.css\");\n/* harmony import */ var _services_animations_element_transform_data_animation_types_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/animations/element-transform/_data/animation-types.js */ \"./src/services/animations/element-transform/_data/animation-types.js\");\n/* harmony import */ var _services_animations_element_transform_element_transform_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/animations/element-transform/element-transform.js */ \"./src/services/animations/element-transform/element-transform.js\");\n\n\n\n\n\n\n\n\naos__WEBPACK_IMPORTED_MODULE_1___default().init();\n\nconst BURGER = document.getElementById('burger');\nconst NAVIGATION = document.getElementById('navigation');\n\nconst PLAY_ICON = document.getElementById('play-icon');\nconst PAUSE_ICON = document.getElementById('pause-icon');\nconst TECHNOLOGICAL_VIDEO = document.getElementById('technological-video');\n\nBURGER.addEventListener('click', () => {\n    let overlay;\n    if (!NAVIGATION.classList.contains('header__navigation_show')) {\n        NAVIGATION.classList.add('header__navigation_show');\n        BURGER.classList.add('header__burger_active');\n\n        overlay = document.createElement('div');\n        overlay.classList.add('overlay');\n        document.body.appendChild(overlay);\n\n        overlay.addEventListener('click', () => {\n            NAVIGATION.classList.remove('header__navigation_show');\n            BURGER.classList.remove('header__burger_active');\n            overlay.remove();\n        });\n    } else {\n        document.querySelector('.overlay')\n            .dispatchEvent(new Event('click'));\n    }\n});\n\ndocument.getElementById('player-button')\n    .addEventListener('click', () => {\n        if (PLAY_ICON.hasAttribute('hidden')) {\n            PLAY_ICON.removeAttribute('hidden');\n            PAUSE_ICON.setAttribute('hidden', '');\n            TECHNOLOGICAL_VIDEO.pause();\n        } else {\n            PAUSE_ICON.removeAttribute('hidden');\n            PLAY_ICON.setAttribute('hidden', '');\n            TECHNOLOGICAL_VIDEO.play();\n        }\n    });\n\ndocument.querySelectorAll('.accordion')\n    .forEach(accordion => {\n        accordion.addEventListener('click', () => {\n            accordion.classList.toggle('accordion_active');\n        });\n    });\n\nconst elementsTransformAnimation = new _services_animations_element_transform_element_transform_js__WEBPACK_IMPORTED_MODULE_4__.ElementTransformController;\n\nelementsTransformAnimation.addAnimation({\n    type: _services_animations_element_transform_data_animation_types_js__WEBPACK_IMPORTED_MODULE_3__.ANIMATION_TYPES.ZOOM_IN,\n    elementWrapperSelector: '#zoom-in-image',\n    elementSelector: 'img',\n    scaleFrom: 1,\n    scaleTo: 1.3\n});\n\nelementsTransformAnimation.addAnimation({\n    type: _services_animations_element_transform_data_animation_types_js__WEBPACK_IMPORTED_MODULE_3__.ANIMATION_TYPES.ZOOM_OUT,\n    elementWrapperSelector: '#zoom-out-image',\n    elementSelector: 'img',\n    scaleFrom: 1.3,\n    scaleTo: 1\n});\n\nelementsTransformAnimation.addAnimation({\n    type: _services_animations_element_transform_data_animation_types_js__WEBPACK_IMPORTED_MODULE_3__.ANIMATION_TYPES.MOVE_TO_RIGHT,\n    elementWrapperSelector: '#slide-to-right-image',\n    elementSelector: 'img',\n    offset: 0.86\n});\n\nelementsTransformAnimation.addAnimation({\n    type: _services_animations_element_transform_data_animation_types_js__WEBPACK_IMPORTED_MODULE_3__.ANIMATION_TYPES.COUNTERCLOCKWISE_ROTATE,\n    elementWrapperSelector: '#price-info-block',\n    elementSelector: '.price-info__label-image',\n    turningAngle: 1420\n});\n\n\n//# sourceURL=webpack://nail/./src/index.js?");

/***/ }),

/***/ "./src/services/animations/element-transform/_data/animation-types.js":
/*!****************************************************************************!*\
  !*** ./src/services/animations/element-transform/_data/animation-types.js ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"ANIMATION_TYPES\": () => (/* binding */ ANIMATION_TYPES)\n/* harmony export */ });\nconst ANIMATION_TYPES = {\n    'ZOOM_IN': 0,\n    'ZOOM_OUT': 1,\n    'MOVE_TO_RIGHT': 2,\n    'MOVE_TO_LEFT': 3,\n    'CLOCKWISE_ROTATE': 4,\n    'COUNTERCLOCKWISE_ROTATE': 5,\n}\n\n\n//# sourceURL=webpack://nail/./src/services/animations/element-transform/_data/animation-types.js?");

/***/ }),

/***/ "./src/services/animations/element-transform/element-transform.js":
/*!************************************************************************!*\
  !*** ./src/services/animations/element-transform/element-transform.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
